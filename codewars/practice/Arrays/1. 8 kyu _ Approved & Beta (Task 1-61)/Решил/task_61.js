...
// Bob is bored during his physics lessons so he's built himself a toy box to help pass the 
// time. The box is special because it has the ability to change gravity.
...
// When Bob switches the gravity, it begins to pull all the cubes to a certain side of the 
// box, d, which can be either 'L' or 'R' (left or right). Below is an example of what a 
// box of cubes might look like before and after switching gravity.
