// 33. Merge two sorted arrays into one
...
//  Complete the function mergeArrays(arr1, arr2), where arr1 and arr2 are 
//  the original sorted arrays.

// You don't need to worry about validation, since arr1 and arr2 must be 
// arrays with 0 or more Integers. If both arr1 and arr2 are empty, then just 
