...
//     point =. The drone always flies left to right, and always begins 
//     at the start of the row of lamps. Anywhere the drone has flown, 
...
// flyBy = (lamps, drone) => lamps.replace(/x/g, (elem, index) => index < drone.length ? 'o' : elem)
