...
// The set of words is given. Words are joined if the last letter of one 
// word and the first letter of another word are the same. Return true if 
// all words of the set can be combined into one word. Each word can and 
// must be used only once. Otherwise return false.
